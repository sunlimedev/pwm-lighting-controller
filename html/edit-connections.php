...
{
    // use filter_var to ensure it is a valid integer
			...
			<div class="p-4">
				<div>
					...
					<div class="font-medium">
						...
						<select class="w-full border border-gray-100 rounded-xl px-4 py-3 mb-2" type="text" id="scene" name="scene"><br>
					...
					<div class="font-medium">
						...
						<input class="w-full border border-gray-100 rounded-xl px-4 py-3 mb-2" type="text" id="note" name="note" value="<?php echo htmlspecialchars($rows1['note']);?>">
					</div>
